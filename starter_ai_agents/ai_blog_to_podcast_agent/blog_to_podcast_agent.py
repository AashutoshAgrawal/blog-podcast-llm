...
# Generate Button
if st.button("🎙️ Generate Podcast", disabled=not all([google_api_key, elevenlabs_key, firecrawl_key])):
    if not url.strip():
